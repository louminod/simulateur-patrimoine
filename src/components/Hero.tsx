  ...
  return (
    <section className="hero-gradient rounded-b-3xl px-6 pt-10 pb-8 md:pt-14 md:pb-10 -mx-4 md:-mx-8 mb-8">
      <div className="max-w-2xl mx-auto text-center">
        ...
        <h1 className="text-3xl md:text-4xl lg:text-5xl font-extrabold text-[var(--text)] leading-tight mb-2">
        ...
        <div className="bg-[var(--overlay)] backdrop-blur-sm rounded-2xl border border-[var(--border)] p-6 md:p-8">
